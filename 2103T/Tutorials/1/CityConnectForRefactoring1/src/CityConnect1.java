...
public class CityConnect1 {
 ...
 private static String addRoute(String userCommand) {
  ...
  int slotPosition = returnSlot(newStartLocation, newEndLocation);
  ...
  */
 private static int returnSlot(String newStartLocation,
   String newEndLocation) {
  ...
  for (int i = 0; i < route.length; i++) {
   ...
   if (existingStartLocation == null|| isSameRoute(existingStartLocation, existingEndLocation,
     newStartLocation, newEndLocation)) {  // change made. empty slot
    return i;
   } 
  }
 ...
 private static boolean isSameRoute(String startLocation1,
  ...
  final boolean isRouteEqual1 = startLocation1.equalsIgnoreCase(startLocation2) && endLocation1
    .equalsIgnoreCase(endLocation2);
  final boolean isRouteEqual2 = startLocation1.equalsIgnoreCase(endLocation2) && endLocation1
      .equalsIgnoreCase(startLocation2);
  
  return (isRouteEqual1 || isRouteEqual2);
 }
